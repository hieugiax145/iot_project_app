...
class ActionHistoryScreenState extends BaseState<ActionHistoryScreen> with BaseScreenMixin {
  @override
  ...
  Widget buildBody(BuildContext context) {
    return Consumer<DataProvider>(builder: (BuildContext context, DataProvider value, Widget? child) {
      return Column(
        children: [
          Padding(
                  ...
                  children: [
                    Flexible(
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: AppThemes.white, borderRadius: BorderRadius.circular(20)),
                        child: const Center(
                          child: TextField(
                    ...
                    TouchableWidget(
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const DataFilter()));
                      },
                      child: Container(
                        padding: const EdgeInsets.all(8),
                        decoration: const BoxDecoration(color: AppThemes.white, shape: BoxShape.circle),
                        child: Image.asset(
